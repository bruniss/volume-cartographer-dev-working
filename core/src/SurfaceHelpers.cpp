...
// Removed duplicate declaration - now using the global variable defined above
...
QuadSurface *grow_surf_from_surfs(SurfaceMeta *seed, const std::vector<SurfaceMeta*> &surfs_v, const nlohmann::json &params)
{
    ...
    // Configure thresholds for high-curvature handling
    ...
    // Print out the configuration for high-curvature handling
    std::cout << "High-curvature configuration:" << std::endl;
